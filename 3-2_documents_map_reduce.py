...
#---------------------------------------
# Step3: 建立LLMChain
#model_name = "gpt-3.5-turbo"        # todo: not work, tokens數不夠
model_name = "gpt-3.5-turbo-16k"   # todo: use this
llm = ChatOpenAI(temperature=0 , model=model_name)

#chain = load_qa_chain(llm=llm)   # todo: not work, 17248 tokens數
chain = load_qa_chain(llm=llm, chain_type="map_reduce")  # todo: use this, 會先做一些摘要, 7007 tokens數, "map_reduce" need pip install tiktoken
